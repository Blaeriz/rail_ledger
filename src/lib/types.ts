...
export function getPriority(daysSinceProduction: number): { level: string; color: string } {
  if (daysSinceProduction > 30) {
    return { level: 'HIGH', color: 'border-red-600 text-white bg-red-500/5 shadow-lg shadow-red-500/10' };
  } else if (daysSinceProduction > 14) {
    return { level: 'MEDIUM', color: 'border-yellow-600 text-white bg-yellow-500/5 shadow-lg shadow-yellow-500/10' };
  } else {
    return { level: 'LOW', color: 'border-green-600 text-white bg-green-500/5 shadow-lg shadow-green-500/10' };
  }
}
...
export function getPriorityColor(priority: string): string {
  ...
  return priorityMap[priority] || 'border-gray-400 text-white bg-gray-500/10 shadow-lg shadow-gray-400/20';
}
...
export function getTicketStatusColor(status: string): string {
  ...
  return statusMap[status] || 'border-gray-400 text-white bg-gray-500/10 shadow-lg shadow-gray-400/20';
}
...
export function getCategoryColor(category: string): string {
  ...
  return categoryMap[category] || 'border-gray-400 text-white bg-gray-500/10 shadow-lg shadow-gray-400/20';
}
