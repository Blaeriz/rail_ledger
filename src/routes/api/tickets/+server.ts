...
let tickets = [
  {
    ...
    description: 'Found quality issues in batch 12345 during inspection. Multiple components showing defects.',
    priority: 'High',
    status: 'Open',
    category: 'Quality',
  ...
  },
  {
    ...
    description: 'Safety equipment in inspection area is not functioning properly. Needs immediate attention.',
    priority: 'Critical',
    status: 'In Progress',
    category: 'Safety',
  ...
  },
  {
    ...
    description: 'Regular maintenance required for inspection equipment. Scheduled maintenance overdue.',
    priority: 'Low',
    status: 'Open',
