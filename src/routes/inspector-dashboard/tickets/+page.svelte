...
<div class="p-4 sm:p-6 lg:p-8">
  ...
  <div class="mb-6 sm:mb-8">
    <h1 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-2">My Tickets</h1>
...
<Modal isOpen={showTicketModal} onClose={closeTicketModal}>
  <div class="bg-gray-800 p-6 rounded-lg max-w-2xl w-full mx-4">
    ...
    <form on:submit|preventDefault={handleSubmit} class="space-y-4">
      <div>
        <label for="inspector-ticket-title" class="block text-sm font-medium text-gray-300 mb-2">Title</label>
        <input 
      ...
      <div>
        <label for="inspector-ticket-description" class="block text-sm font-medium text-gray-300 mb-2">Description</label>
        <textarea 
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <label for="inspector-ticket-priority" class="block text-sm font-medium text-gray-300 mb-2">Priority</label>
          <select 
        ...
        <div>
          <label for="inspector-ticket-status" class="block text-sm font-medium text-gray-300 mb-2">Status</label>
          <select 
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <label for="inspector-ticket-category" class="block text-sm font-medium text-gray-300 mb-2">Category</label>
          <select 
        ...
        <div>
          <label for="inspector-ticket-assigned" class="block text-sm font-medium text-gray-300 mb-2">Assign To</label>
          <input 
