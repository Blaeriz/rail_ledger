...
<script>
  ...
  function getPriorityColor(/** @type {string} */ priority) {
    switch (priority) {
  ...
  function getPriorityText(/** @type {string} */ priority) {
    switch (priority) {
...
<svelte:head>
  <title>AI Reports - Inspector Dashboard</title>
</svelte:head>
...
<div class="p-6 space-y-6">
  ...
  <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
    <div>
      <h1 class="text-2xl sm:text-3xl font-bold text-white mb-2">AI Inspection Reports</h1>
      <p class="text-gray-400">AI-powered insights for quality inspections and safety assessments</p>
    </div>
    <div class="mt-4 sm:mt-0 flex flex-col sm:flex-row gap-3">
      <select
        bind:value={generateType}
        class="px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
      >
      ...
      <button 
        ...
        class="bg-blue-600 hover:bg-blue-700 disabled:bg-gray-600 disabled:cursor-not-allowed text-white px-6 py-3 rounded-lg font-medium transition-all duration-300 border border-blue-500/30 hover:border-blue-400/50 hover:shadow-lg hover:shadow-blue-500/20"
      >
        {#if isGenerating}
        ...
        >
          <div class="flex items-start justify-between mb-4">
            ...
            <div class="flex flex-col space-y-2">
              ...
              {#if report.priority}
                <span class="px-3 py-1 rounded-full text-xs font-medium border {getPriorityColor(report.priority)}">
          ...
          <div class="space-y-2 mb-4">
            ...
            <div class="flex items-center text-sm text-gray-400">
              <Icon name="search" size="w-4 h-4" className="mr-2" />
              {report.type}
            </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            {#if selectedReport.priority}
              <div class="bg-gray-700/50 rounded-lg p-4">
                ...
                <div class="text-white font-medium">{getPriorityText(selectedReport.priority)}</div>
              </div>
            {/if}
          </div>
