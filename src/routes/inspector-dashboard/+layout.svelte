...
<script>
  ...
  // Navigation items for inspector with professional icons
  const navItems = [
    { id: 'quality', label: 'Quality Analysis', href: '/inspector-dashboard/quality', icon: 'chart' },
    { id: 'inspections', label: 'Inspections', href: '/inspector-dashboard/inspections', icon: 'search' },
    { id: 'pending', label: 'Pending', href: '/inspector-dashboard/pending', icon: 'clock' },
    { id: 'tickets', label: 'My Tickets', href: '/inspector-dashboard/tickets', icon: 'ticket' },
    { id: 'schedule', label: 'Schedule', href: '/inspector-dashboard/schedule', icon: 'calendar' }
  ];
...
<svelte:head>
  <title>Inspector Dashboard - Rail Ledger</title>
</svelte:head>
              ...
              <div class="p-4">
                <div class="flex items-center space-x-3 mb-4">
                  ...
                  <div>
                    ...
                    <p class="text-gray-400 text-xs">inspector</p>
                  </div>
                </div>
                ...
                <div class="border-t border-gray-700 pt-3">
                  <div class="space-y-2">
                    ...
                    <div class="flex justify-between text-xs">
                      ...
                      <span class="text-blue-400">Inspector</span>
                    </div>
                    <div class="flex justify-between text-xs">
