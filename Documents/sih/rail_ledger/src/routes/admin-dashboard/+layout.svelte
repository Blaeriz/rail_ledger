...
<script>
	...
	const navItems = [
		{ id: 'analytics', label: 'Analytics', href: '/admin-dashboard/analytics', icon: 'analytics' },
		{ id: 'overview', label: 'Dashboard', href: '/admin-dashboard/overview', icon: 'home' },
		{ id: 'vendors', label: 'Vendors', href: '/admin-dashboard/vendors', icon: 'building' },
		...
		{ id: 'heatmap', label: 'Heatmap', href: '/admin-dashboard/heatmap', icon: 'map' },
...
<svelte:head>
	<title>Admin Dashboard - Rail Ledger</title>
</svelte:head>
						...
						>
							<div class="p-4">
								<div class="mb-4 flex items-center space-x-3">
									<div
										class="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-purple-500 to-blue-500"
									>
								...
								<div class="border-t border-gray-700 pt-3">
									<div class="space-y-2">
										...
										<div class="flex justify-between text-xs">
											...
											<span class="text-purple-400">Administrator</span>
										</div>
										<div class="flex justify-between text-xs">
