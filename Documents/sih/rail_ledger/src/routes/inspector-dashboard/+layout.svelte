	...
	const navItems = [
		{
			...
			href: '/inspector-dashboard/quality',
			icon: 'chart'
		},
		{
			id: 'inspections',
		...
		{ id: 'heatmap', label: 'Heatmap', href: '/inspector-dashboard/heatmap', icon: 'map' },
		{ id: 'ai_overview', label: 'AI Overview', href: '/inspector-dashboard/ai_overview', icon: 'robot' }
	];
